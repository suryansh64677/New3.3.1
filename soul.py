...
TOKEN = '7327846574:AAEUHlqxGgyVMTa1s2NmFzqy0um1fBIOJwc'
...
FORWARD_CHANNEL_ID = -1001959411355
CHANNEL_ID = -1001959411355
error_channel_id = -1001959411355
...
def handle_message(message):
    if message.text == "Instant Plan😈":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/suryanshrl*", parse_mode='Markdown')
